...
import { playSong, createLocalPlaylistForPlaying } from "../../actions/player.action";
...
class PlayList extends Component {
    ...
    componentWillReceiveProps(newProps) {
        ...
        if (newProps.playlist_detail) {
            this.setState({
                ...
                'showLoadMore': (newProps.playlist_detail.tracks.items.length > 10)
            });
        }
    }
    ...
    playPlaylist() {
        console.log(this.state)
        this.props.createLocalPlaylistForPlaying(this.state.totalSongs);
            ...
            return (
                <div className="artist-intro-container">
                    ...
                    <div className="artist-details">
                        ...
                        <p className="followers">{(playlist_detail.tracks.items.length) + ((playlist_detail.tracks.items.length > 1) ? " Songs" : " Song")}</p>
                    </div>
...
export default connect(
    mapStateToProps,
    { fetchPlayListDetails, playSong, createLocalPlaylistForPlaying }
)(PlayList);