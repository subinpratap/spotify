...
import { fetchAlbum, addSongToUserPlaylists } from "../../actions/spotify.action";
                ...
                return items.map(track => {
                    return (
                        <div className="item" key={track.id} onClick={(e) => { e.preventDefault(); this.props.playSong(`spotify:track:${track.id}`) }}>
                            ...
                            <a className="like" onClick={() => { this.checkPlaylistAndaddToFavouriteSongs(track.id) }}><i className="fas fa-heart"></i></a>
...
export default connect(
    mapStateToProps,
    { fetchAlbum, playSong, addSongToUserPlaylists }
)(Album);